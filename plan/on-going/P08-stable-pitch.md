...
- A low lock below 150 Hz climbs to τ/2, τ/3, or τ/4 when that divisor is still a valley. Analysis highpass is two poles at 180 Hz, so 70–100 Hz energy no longer shoves E4 sharp into F4 or onto the C♯2 floor. A dip that never clears the YIN threshold is dropped instead of shown. Buried low E stays on E2.
