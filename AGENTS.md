...
P05 done. **P06** in progress (PWA shell in; iPhone check waits on Pages HTTPS). **P07** in progress. Toolchain in `flake.nix` (Node 26, Yarn classic, Emscripten, CMake, Ninja).
